                ...
                <div class="widget-box">
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            <form class="form-horizontal" action="{{url('filtredip_ensam')}}" method="get" style="width: 200px;margin-left: 20px;">
                                {{csrf_field()}}
                                <div>
                                    <label for="form-field-select-1"><b>@lang('list.filtre1')</b></label>
                                    <select class="chosen-select form-control" name="filiere_ensam" id="form-field-select-3" style="margin-bottom: 10px;" data-placeholder="Choose a State...">
                                ...
                                <div>
                                    <select class="form-control" name="diplome_ensam" id="form-field-select-1" style="margin-bottom: 10px;">
                            ...
                            <hr />
                            <form class="form-horizontal" action="{{url('filtre_ensam')}}" method="get" style="width: 200px;margin-left: 20px;">
                                {{csrf_field()}}
                                <div>
