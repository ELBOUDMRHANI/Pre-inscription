...
<div class="main-container ace-save-state" id="main-container">
    ...
    <div id="sidebar" class="sidebar                  responsive                    ace-save-state">
        ...
        <ul class="nav nav-list">
            ...
            @endhasanyrole
            @hasanyrole('SuperAdmin|admin_ESTM|admin_ENSAM|admin_ENS|admin_FS|admin_FSLH|admin_FPE|admin_FST|admin_FSJES|Responsable')
            <li>
                ...
                <ul class="submenu">
                    @hasanyrole('SuperAdmin|Responsable')
                    <li class="">
                    ...
                    @endhasanyrole
                    @hasanyrole('SuperAdmin|admin_ESTM|Responsable')
                    <li class="">
                    ...
                    @endhasanyrole
                    @hasanyrole('SuperAdmin|admin_ENSAM|Responsable')
                    <li class="">
                    ...
                    @endhasanyrole
                    @hasanyrole('SuperAdmin|admin_FSJES|Responsable')
                    <li class="">
                    ...
                    @endhasanyrole
                    @hasanyrole('SuperAdmin|admin_FLSH|Responsable')
                    <li class="">
                    ...
                    @endhasanyrole
                    @hasanyrole('SuperAdmin|admin_FS|Responsable')
                    <li class="">
                    ...
                    @endhasanyrole
                    @hasanyrole('SuperAdmin|admin_FPE|Responsable')
                    <li class="">
                    ...
                    @endhasanyrole
                    @hasanyrole('SuperAdmin|admin_FST|Responsable')
                    <li class="">
                    ...
                    @endhasanyrole
                    @hasanyrole('SuperAdmin|admin_ENS|Responsable')
                    <li class="">
