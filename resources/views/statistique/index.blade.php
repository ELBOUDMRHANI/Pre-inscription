            ...
            <div class="widget-main">
                ...
                <div class="clearfix">
                    <div class="grid3">
                        ...
                        <h4 class="bigger pull-right">{{ Session::get('valid')}}</h4>
                    </div>
                    ...
                    <div class="grid3">
                        ...
                        <h4 class="bigger pull-right">{{ Session::get('non_valid')}}</h4>
                    </div>
                    ...
                    <div class="grid3">
                        ...
                        <?php $tot= Session::get('valid')+Session::get('non_valid') ; ?>
            ...
            <div class="widget-box">
                <div class="widget-header widget-header-flat widget-header-small">
                    ...
                    <div class="widget-toolbar no-border">
                        ...
                        <form class="form-horizontal" action="{{url('stat_fil')}}" method="get" style="width: 200px;margin-left: 20px;">
                            {{csrf_field()}}
                            <select class="chosen-select form-control" name="fil" id="form-field-select-3" data-placeholder="Choose a State...">
                            ...
                            <input type="hidden" id="valide_fil" value="{{ Session::get('valide_fil')}}"/>
                            <input type="hidden" id="non_valide_fil" value="{{ Session::get('non_valide_fil')}}"/>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="widget-main">
                        ...
                        <div class="clearfix">
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('valide_fil')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('non_valide_fil')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <?php $tot= Session::get('valide_fil')+Session::get('non_valide_fil') ; ?>
                                <h4 class="bigger pull-right"><?=$tot?></h4>
                            </div>
                        </div>
                    </div><!-- /.widget-main -->
            ...
            <div class="widget-box">
                <div class="widget-header widget-header-flat widget-header-small">
                    ...
                    <div class="widget-toolbar no-border">
                        ...
                        <form class="form-horizontal" action="{{url('stat_bac')}}" method="get" style="width: 200px;margin-left: 20px;">
                            {{csrf_field()}}
                            <select class="chosen-select form-control" name="bac" id="form-field-select-3" data-placeholder="Choose a State...">
                            ...
                            <input type="hidden" id="valide_bac" value="{{ Session::get('valide_bac')}}"/>
                            <input type="hidden" id="non_valide_bac" value="{{ Session::get('non_valide_bac')}}"/>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="widget-main" style="margin-left: -73px;">
                        ...
                        <div class="clearfix">
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('valide_bac')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('non_valide_bac')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <?php $tot= Session::get('valide_bac')+Session::get('non_valide_bac') ; ?>
                                <h4 class="bigger pull-right"><?=$tot?></h4>
                            </div>
                        </div>
                    </div><!-- /.widget-main -->
    ...
    <div class="widget-box">
                    <div class="widget-header widget-header-flat widget-header-small">
                        ...
                        <div class="widget-toolbar no-border">
                            ...
                            <form class="form-horizontal" action="{{url('stat_prov')}}" method="get" style="width: 200px;margin-left: 20px;">
                                {{csrf_field()}}

                                <select class="chosen-select form-control" name="prov" id="form-field-select-3" data-placeholder="Choose a State...">
                                    <option  value="21">{{ Session::get('nom_province')}}</option>
                                ...
                                <input type="hidden" id="valide_prov" value="{{ Session::get('valide_prov')}}"/>
                                <input type="hidden" id="non_valide_prov" value="{{ Session::get('non_valide_prov')}}"/>
                            </form>
                      </div>
        </div>
        ...
        <div class="widget-main">
            ...
            <div class="clearfix">
                <div class="grid3">
                    ...
                    <h4 class="bigger pull-right">{{ Session::get('valide_prov')}}</h4>
                </div>
                ...
                <div class="grid3">
                    ...
                    <h4 class="bigger pull-right">{{ Session::get('non_valide_prov')}}</h4>
                </div>
                ...
                <div class="grid3">
                    ...
                    <?php $tot= Session::get('valide_prov')+Session::get('non_valide_prov') ; ?>
                    <h4 class="bigger pull-right"><?=$tot?></h4>
                </div>
            </div>
        </div><!-- /.widget-main -->
    ...
    <div class="widget-box">
        <div class="widget-header widget-header-flat widget-header-small">
            ...
            <div class="widget-toolbar no-border">
                ...
                <form class="form-horizontal" action="{{url('stat_aca')}}" method="get" style="width: 200px;margin-left: 20px;">
                    {{csrf_field()}}
                    <select class="chosen-select form-control" name="aca" id="form-field-select-3" data-placeholder="Choose a State...">
                    ...
                    <input type="hidden" id="valide_aca" value="{{ Session::get('valide_aca')}}"/>
                    <input type="hidden" id="non_valide_aca" value="{{ Session::get('non_valide_aca')}}"/>
                </form>
            </div>
        </div>
            ...
            <div class="widget-main">
                ...
                <div class="clearfix">
                    <div class="grid3">
                        ...
                        <h4 class="bigger pull-right">{{ Session::get('valide_aca')}}</h4>
                    </div>
                    ...
                    <div class="grid3">
                        ...
                        <h4 class="bigger pull-right">{{ Session::get('non_valide_aca')}}</h4>
                    </div>
                    ...
                    <div class="grid3">
                        ...
                        <?php $tot= Session::get('valide_aca')+Session::get('non_valide_aca') ; ?>
                        <h4 class="bigger pull-right"><?=$tot?></h4>
                    </div>
                </div>
            </div><!-- /.widget-main -->
...
<input type="hidden" id="valide" value="{{ Session::get('valid')}}"/>
<input type="hidden" id="non_valide" value="{{ Session::get('non_valid')}}"/>
...
<script src="{{asset('assets/js/jquery.flot.resize.min.js')}}"></script>
    ...
    jQuery(function($) {
        ...
        var data = [
            { label: "les étudiants qui ont validé leurs inscription",  data: va},
            { label: "les étudiants qui n'ont pas validé leurs inscription",  data: no_va}
        ]
