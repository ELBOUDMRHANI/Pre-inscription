...
@section('content')
                    ...
                    <div class="widget-main">
                        ...
                        <div class="clearfix">
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('valid_fst')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('non_valid_fst')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <?php $tot= Session::get('valid_fst')+Session::get('non_valid_fst') ; ?>
            ...
            <div class="widget-box">
                <div class="widget-header widget-header-flat widget-header-small">
                    ...
                    <div class="widget-toolbar no-border">
                        ...
                        <form class="form-horizontal" action="{{url('stat_fil_fst')}}" method="get" style="width: 200px;margin-left: 20px;">
                            {{csrf_field()}}
                            <select class="chosen-select form-control" name="fil_fst" id="form-field-select-3" data-placeholder="Choose a State...">
                            ...
                            <input type="hidden" id="valide_fil_fst" value="{{ Session::get('valide_fil_fst')}}"/>
                            <input type="hidden" id="non_valide_fil_fst" value="{{ Session::get('non_valide_fil_fst')}}"/>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="widget-main">
                        ...
                        <div class="clearfix">
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('valide_fil_fst')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('non_valide_fil_fst')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <?php $tot= Session::get('valide_fil_fst')+Session::get('non_valide_fil_fst') ; ?>
                                <h4 class="bigger pull-right"><?=$tot?></h4>
                            </div>
                        </div>
                    </div><!-- /.widget-main -->
            ...
            <div class="widget-box">
                <div class="widget-header widget-header-flat widget-header-small">
                    ...
                    <div class="widget-toolbar no-border">
                        ...
                        <form class="form-horizontal" action="{{url('stat_bac_fst')}}" method="get" style="width: 200px;margin-left: 20px;">
                            {{csrf_field()}}
                            <select class="chosen-select form-control" name="bac_fst" id="form-field-select-3" data-placeholder="Choose a State...">
                            ...
                            <input type="hidden" id="valide_bac_fst" value="{{ Session::get('valide_bac_fst')}}"/>
                            <input type="hidden" id="non_valide_bac_fst" value="{{ Session::get('non_valide_bac_fst')}}"/>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="widget-main" style="margin-left: -73px;">
                        ...
                        <div class="clearfix">
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('valide_bac_fst')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('non_valide_bac_fst')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <?php $tot= Session::get('valide_bac_fst')+Session::get('non_valide_bac_fst') ; ?>
                                <h4 class="bigger pull-right"><?=$tot?></h4>
                            </div>
                        </div>
                    </div><!-- /.widget-main -->
            ...
            <div class="widget-box">
                <div class="widget-header widget-header-flat widget-header-small">
                    ...
                    <div class="widget-toolbar no-border">
                        ...
                        <form class="form-horizontal" action="{{url('stat_prov_fst')}}" method="get" style="width: 200px;margin-left: 20px;">
                            {{csrf_field()}}

                            <select class="chosen-select form-control" name="prov_fst" id="form-field-select-3" data-placeholder="Choose a State...">
                            ...
                            <input type="hidden" id="valide_prov_fst" value="{{ Session::get('valide_prov_fst')}}"/>
                            <input type="hidden" id="non_valide_prov_fst" value="{{ Session::get('non_valide_prov_fst')}}"/>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="widget-main">
                        ...
                        <div class="clearfix">
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('valide_prov_fst')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('non_valide_prov_fst')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <?php $tot= Session::get('valide_prov_fst')+Session::get('non_valide_prov_fst') ; ?>
                                <h4 class="bigger pull-right"><?=$tot?></h4>
                            </div>
                        </div>
                    </div><!-- /.widget-main -->
            ...
            <div class="widget-box">
                <div class="widget-header widget-header-flat widget-header-small">
                    ...
                    <div class="widget-toolbar no-border">
                        ...
                        <form class="form-horizontal" action="{{url('stat_aca_fst')}}" method="get" style="width: 200px;margin-left: 20px;">
                            {{csrf_field()}}
                            <select class="chosen-select form-control" name="aca_fst" id="form-field-select-3" data-placeholder="Choose a State...">
                            ...
                            <input type="hidden" id="valide_aca_fst" value="{{ Session::get('valide_aca_fst')}}"/>
                            <input type="hidden" id="non_valide_aca_fst" value="{{ Session::get('non_valide_aca_fst')}}"/>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="widget-main">
                        ...
                        <div class="clearfix">
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('valide_aca_fst')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('non_valide_aca_fst')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <?php $tot= Session::get('valide_aca_fst')+Session::get('non_valide_aca_fst') ; ?>
                                <h4 class="bigger pull-right"><?=$tot?></h4>
                            </div>
                        </div>
                    </div><!-- /.widget-main -->
    ...
    <input type="hidden" id="valide_fst" value="{{ Session::get('valid_fst')}}"/>
    <input type="hidden" id="non_valide_fst" value="{{ Session::get('non_valid_fst')}}"/>
    ...
    <script type="text/javascript">
        jQuery(function($) {
            ...
            var va = document.getElementById("valide_fst").value;
            var no_va = document.getElementById("non_valide_fst").value;
            var data = [
            ...
            var vaa = document.getElementById("valide_prov_fst").value;
            var no_vaa = document.getElementById("non_valide_prov_fst").value;
            var dataa = [
            ...
            var va_aca = document.getElementById("valide_aca_fst").value;
            var no_va_aca = document.getElementById("non_valide_aca_fst").value;
            var data_aca = [
            ...
            var va_fil = document.getElementById("valide_fil_fst").value;
            var no_va_fil = document.getElementById("non_valide_fil_fst").value;
            var data_fil = [
            ...
            var va_bac = document.getElementById("valide_bac_fst").value;
            var no_va_bac = document.getElementById("non_valide_bac_fst").value;
            var data_bac = [
