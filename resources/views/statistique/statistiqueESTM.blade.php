...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-5">
            <div style="position: relative;top:280px;left:20px;">
                <?php $total_insc=$val_estm+$nn_val_estm;?>
                <div class="infobox infobox-red infobox-small infobox-dark" style="width: 150px">
                    ...
                    <div class="infobox-data">
                        <div class="infobox-content" style="width: 100px">Non Valide
                            <div style="font-size: 18px;font-weight: bold;margin-left: 10px;">{{$nn_val_estm}}</div></div>
                    </div>
                </div>
                ...
                <div class="infobox infobox-green infobox-small infobox-dark" style="width: 150px">
                    ...
                    <div class="infobox-data">
                        ...
                        <div class="infobox-content" style="font-size: 18px;font-weight: bold">{{$val_estm}}</div>
                    </div>
                </div>
        ...
        <div class="col-sm-7" >
            <div class="widget-box">
                ...
                <h4 style="margin-left: 10px ;height: 40px;" class="bigger pull-left">totale inscriptions sur les filieres ESTM</h4>

                <div class="widget-body"style="padding-top: 20px" >

                    <div class="widget-main" style="padding-top: 40px">
                        ...
                        <div class="clearfix" style="margin-top: 20px;">
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('max_fil_estm')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('min_fil_estm')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('moy_fil_estm')}}</h4>
                            </div>
                        </div>
                    </div><!-- /.widget-main -->
                </div><!-- /.widget-body -->
            ...
            <div class="widget-box">
                ...
                <div class="widget-body" style="padding-top: 20px">
                    <div class="widget-main" >
                        <div id="piechart-placeholder_acad"style="padding-top: 20px" ></div>
                        ...
                        <div class="clearfix" style="margin-top: 20px;">
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('max_aca_estm')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('min_aca_estm')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('moy_aca_estm')}}</h4>
                            </div>
                        </div>
                    </div><!-- /.widget-main -->
                </div><!-- /.widget-body -->
                    ...
                    <div class="widget-main" >
                        ...
                        <div class="clearfix" style="margin-top: 20px;">
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('max_pro_estm')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('min_pro_estm')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('moy_pro_estm')}}</h4>
                            </div>
                        </div>
                    </div><!-- /.widget-main -->
                </div><!-- /.widget-body -->
    ...
    <div class="col-sm-7">
        <div class="widget-box">
            ...
            <h4 style="margin-left: 10px ;height: 40px;" class="bigger pull-left">totale inscriptions sur les series bac</h4>
                ...
                <div class="widget-main" >
                    ...
                    <div class="clearfix" style="margin-top: 20px;">
                        <div class="grid3">
                            ...
                            <h4 class="bigger pull-right">{{ Session::get('max_bac_estm')}}</h4>
                        </div>
                        ...
                        <div class="grid3">
                            ...
                            <h4 class="bigger pull-right">{{ Session::get('min_bac_estm')}}</h4>
                        </div>
                        ...
                        <div class="grid3">
                            ...
                            <h4 class="bigger pull-right">{{ Session::get('moy_bac_estm')}}</h4>
                        </div>
                    </div>
                </div><!-- /.widget-main -->
            </div><!-- /.widget-body -->
