    ...
    <div class="row">
        <div class="col-sm-5">
            <div style="position: relative;top:250px;left:20px;">
                <?php $total_insc=$val_ens+$nn_val_ens;?>
                <div class="infobox infobox-red infobox-small infobox-dark" style="width: 150px">
                    ...
                    <div class="infobox-data">
                        <div class="infobox-content" style="width: 100px">Non Valide
                            <div style="font-size: 18px;font-weight: bold;margin-left: 10px;">{{$nn_val_ens}}</div></div>
                    </div>
                </div>
                ...
                <div class="infobox infobox-green infobox-small infobox-dark" style="width: 150px">
                    ...
                    <div class="infobox-data">
                        ...
                        <div class="infobox-content" style="font-size: 18px;font-weight: bold">{{$val_ens}}</div>
                    </div>
                </div>
                    ...
                    <div class="widget-main" >
                        ...
                        <div class="clearfix" style="margin-top: 20px;">
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('max_fil_ens')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('min_fil_ens')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('moy_fil_ens')}}</h4>
                            </div>
                        </div>
                    </div><!-- /.widget-main -->
                </div><!-- /.widget-body -->
                    ...
                    <div class="widget-main" >
                        ...
                        <div class="clearfix" style="margin-top: 20px;">
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('max_aca_ens')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('min_aca_ens')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('moy_aca_ens')}}</h4>
                            </div>
                        </div>
                    </div><!-- /.widget-main -->
                </div><!-- /.widget-body -->
                    ...
                    <div class="widget-main" >
                        ...
                        <div class="clearfix" style="margin-top: 20px;">
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('max_pro_ens')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('min_pro_ens')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('moy_pro_ens')}}</h4>
                            </div>
                        </div>
                    </div><!-- /.widget-main -->
                </div><!-- /.widget-body -->
                ...
                <div class="widget-main" >
                    ...
                    <div class="clearfix" style="margin-top: 20px;">
                        <div class="grid3">
                            ...
                            <h4 class="bigger pull-right">{{ Session::get('max_bac_ens')}}</h4>
                        </div>
                        ...
                        <div class="grid3">
                            ...
                            <h4 class="bigger pull-right">{{ Session::get('min_bac_ens')}}</h4>
                        </div>
                        ...
                        <div class="grid3">
                            ...
                            <h4 class="bigger pull-right">{{ Session::get('moy_bac_ens')}}</h4>
                        </div>
                    </div>
                </div><!-- /.widget-main -->
            </div><!-- /.widget-body -->
