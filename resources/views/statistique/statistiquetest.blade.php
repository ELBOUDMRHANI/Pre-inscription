    ...
    <div class="row" xmlns="http://www.w3.org/1999/html">
        <div class="col-sm-5">
            ...
            <div class="infobox infobox-red infobox-small infobox-dark" style="width: 150px">
                ...
                <div class="infobox-data">
                    <div class="infobox-content" style="width: 100px">Non Valide
                        <div style="font-size: 18px;font-weight: bold;margin-left: 10px;">{{$nn_val}}</div></div>
                </div>
            </div>
            ...
            <div class="infobox infobox-green infobox-small infobox-dark" style="width: 150px">
                ...
                <div class="infobox-data">
                    ...
                    <div class="infobox-content" style="font-size: 18px;font-weight: bold">{{$val}}</div>
                </div>
            </div>
        ...
        <div class="col-sm-7" >
            <div class="widget-box">
                ...
                <h4 style="margin-left: 10px ;" class="bigger pull-left">totale inscriptions sur les etablissements</h4>
                <div class="widget-body" style="padding-top: 30px;margin-left: 15px;" >
                    <div class="widget-main" >
                        <div id="piechart-placeholder_etab"></div>

                        <div class="hr hr8 hr-double" ></div>

                        <div class="clearfix" style="margin-top: 20px;margin-left:10px">
                            <div class="grid3">
															<span class="grey">
																<i class="ace-icon fa fa-check fa-2x green"></i>
																&nbsp; max valide
															</span>
                                <h4 class="bigger pull-right">{{ Session::get('max_etab')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('min_etab')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('moy_etab')}}</h4>
                            </div>
                        </div>
                    </div><!-- /.widget-main -->
                </div><!-- /.widget-body -->
    ...
    <div class="row">
        <div class="col-sm-7" >
            <div class="widget-box">
                ...
                <h4 style="margin-left: 10px ;height: 40px;" class="bigger pull-left">totale inscriptions sur les filieres</h4>
                    ...
                    <div class="widget-main" >
                        ...
                        <div class="clearfix" style="margin-top: 20px;">
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('max_fil')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('min_fil')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('moy_fil')}}</h4>
                            </div>
                        </div>
                    </div><!-- /.widget-main -->
                </div><!-- /.widget-body -->
    ...
    <div class="row">
        <div class="col-sm-7">
            <div class="widget-box">
                ...
                <h4 style="margin-left: 10px ;height: 40px;" class="bigger pull-left">totale inscriptions sur les academies</h4>
                <div class="widget-body" style="padding-top: 20px">
                    <div class="widget-main" >
                        ...
                        <div class="clearfix" style="margin-top: 20px;">
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('max_aca')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('min_aca')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('moy_aca')}}</h4>
                            </div>
                        </div>
                    </div><!-- /.widget-main -->
                </div><!-- /.widget-body -->
    ...
    <div class="row">
        <div class="col-sm-7">
            <div class="widget-box">
                ...
                <h4 style="margin-left: 10px ;height: 40px;" class="bigger pull-left">totale inscriptions sur les provinces</h4>
                <div class="widget-body" style="padding-top: 20px">
                    <div class="widget-main" >
                    ...
                    <div class="clearfix" style="margin-top: 20px;">
                        <div class="grid3">
                            ...
                            <h4 class="bigger pull-right">{{ Session::get('max_pro')}}</h4>
                        </div>
                        ...
                        <div class="grid3">
                            ...
                            <h4 class="bigger pull-right">{{ Session::get('min_pro')}}</h4>
                        </div>
                        ...
                        <div class="grid3">
                            ...
                            <h4 class="bigger pull-right">{{ Session::get('moy_pro')}}</h4>
                        </div>
                    </div>
                </div><!-- /.widget-main -->
            </div><!-- /.widget-body -->
    ...
    <div class="row">
        ...
        <div class="col-sm-7">
                <div class="widget-box">
                    ...
                    <h4 style="margin-left: 10px ;height: 40px;" class="bigger pull-left">totale inscriptions sur les serie bac</h4>
                    <div class="widget-body" style="padding-top: 20px">
                        <div class="widget-main" >
                            ...
                            <div class="clearfix" style="margin-top: 20px;">
                                <div class="grid3">
                                    ...
                                    <h4 class="bigger pull-right">{{ Session::get('max_bac')}}</h4>
                                </div>
                                ...
                                <div class="grid3">
                                    ...
                                    <h4 class="bigger pull-right">{{ Session::get('min_bac')}}</h4>
                                </div>
                                ...
                                <div class="grid3">
                                    ...
                                    <h4 class="bigger pull-right">{{ Session::get('moy_bac')}}</h4>
                                </div>
                            </div>
                        </div><!-- /.widget-main -->
                    </div><!-- /.widget-body -->
        ...
        //    var vaa = document.getElementById("valide_prov").value;
         //   var no_vaa = document.getElementById("non_valide_prov").value;
          ...
          //  var no_va_fil = document.getElementById("non_valide_fil").value;
            ...
            //////////////////////
            var placeholder5 = $('#piechart-placeholder_etab').css({'width':'97%' , 'min-height':'200px','height':'100%'});
           // var va_bac = document.getElementById("valide_bac").value;
           // var no_va_bac = document.getElementById("non_valide_bac").value;
            var data_etab = [
                @foreach($Data_etab as $de)
                {
                    label: "Etablissement : ".concat(<?php echo json_encode($de->name);?>),
                    data:<?php echo json_encode($de->value);?> },
                @endforeach
            ]
            function drawPieChart(placeholder5, data_etab, position) {
                $.plot(placeholder5, data_etab, {
                    series: {
                        pie: {
                            show: true,
                            tilt:0.8,
            ...
            drawPieChart(placeholder5, data_etab);

            /**
             we saved the drawing function and the data to redraw with different position later when switching to RTL mode dynamically
             so that's not needed actually.
             */
            placeholder5.data('chart', data_etab);
