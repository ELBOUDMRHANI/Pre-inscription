...
@section('content')
                    ...
                    <div class="widget-main">
                        ...
                        <div class="clearfix">
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('valid_fs')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('non_valid_fs')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <?php $tot= Session::get('valid_fs')+Session::get('non_valid_fs') ; ?>
            ...
            <div class="widget-box">
                <div class="widget-header widget-header-flat widget-header-small">
                    ...
                    <div class="widget-toolbar no-border">
                        ...
                        <form class="form-horizontal" action="{{url('stat_fil_fs')}}" method="get" style="width: 200px;margin-left: 20px;">
                            {{csrf_field()}}
                            <select class="chosen-select form-control" name="fil_fs" id="form-field-select-3" data-placeholder="Choose a State...">
                            ...
                            <input type="hidden" id="valide_fil_fs" value="{{ Session::get('valide_fil_fs')}}"/>
                            <input type="hidden" id="non_valide_fil_fs" value="{{ Session::get('non_valide_fil_fs')}}"/>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="widget-main">
                        ...
                        <div class="clearfix">
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('valide_fil_fs')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('non_valide_fil_fs')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <?php $tot= Session::get('valide_fil_fs')+Session::get('non_valide_fil_fs') ; ?>
                                <h4 class="bigger pull-right"><?=$tot?></h4>
                            </div>
                        </div>
                    </div><!-- /.widget-main -->
            ...
            <div class="widget-box">
                <div class="widget-header widget-header-flat widget-header-small">
                    ...
                    <div class="widget-toolbar no-border">
                        ...
                        <form class="form-horizontal" action="{{url('stat_bac_fs')}}" method="get" style="width: 200px;margin-left: 20px;">
                            {{csrf_field()}}
                            <select class="chosen-select form-control" name="bac_fs" id="form-field-select-3" data-placeholder="Choose a State...">
                            ...
                            <input type="hidden" id="valide_bac_fs" value="{{ Session::get('valide_bac_fs')}}"/>
                            <input type="hidden" id="non_valide_bac_fs" value="{{ Session::get('non_valide_bac_fs')}}"/>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="widget-main" style="margin-left: -73px;">
                        ...
                        <div class="clearfix">
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('valide_bac_fs')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('non_valide_bac_fs')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <?php $tot= Session::get('valide_bac_fs')+Session::get('non_valide_bac_fs') ; ?>
                                <h4 class="bigger pull-right"><?=$tot?></h4>
                            </div>
                        </div>
                    </div><!-- /.widget-main -->
            ...
            <div class="widget-box">
                <div class="widget-header widget-header-flat widget-header-small">
                    ...
                    <div class="widget-toolbar no-border">
                        ...
                        <form class="form-horizontal" action="{{url('stat_prov_fs')}}" method="get" style="width: 200px;margin-left: 20px;">
                            {{csrf_field()}}

                            <select class="chosen-select form-control" name="prov_fs" id="form-field-select-3" data-placeholder="Choose a State...">
                            ...
                            <input type="hidden" id="valide_prov_fs" value="{{ Session::get('valide_prov_fs')}}"/>
                            <input type="hidden" id="non_valide_prov_fs" value="{{ Session::get('non_valide_prov_fs')}}"/>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="widget-main">
                        ...
                        <div class="clearfix">
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('valide_prov_fs')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('non_valide_prov_fs')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <?php $tot= Session::get('valide_prov_fs')+Session::get('non_valide_prov_fs') ; ?>
                                <h4 class="bigger pull-right"><?=$tot?></h4>
                            </div>
                        </div>
                    </div><!-- /.widget-main -->
            ...
            <div class="widget-box">
                <div class="widget-header widget-header-flat widget-header-small">
                    ...
                    <div class="widget-toolbar no-border">
                        ...
                        <form class="form-horizontal" action="{{url('stat_aca_fs')}}" method="get" style="width: 200px;margin-left: 20px;">
                            {{csrf_field()}}
                            <select class="chosen-select form-control" name="aca_fs" id="form-field-select-3" data-placeholder="Choose a State...">
                            ...
                            <input type="hidden" id="valide_aca_fs" value="{{ Session::get('valide_aca_fs')}}"/>
                            <input type="hidden" id="non_valide_aca_fs" value="{{ Session::get('non_valide_aca_fs')}}"/>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="widget-main">
                        ...
                        <div class="clearfix">
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('valide_aca_fs')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right">{{ Session::get('non_valide_aca_fs')}}</h4>
                            </div>
                            ...
                            <div class="grid3">
                                ...
                                <?php $tot= Session::get('valide_aca_fs')+Session::get('non_valide_aca_fs') ; ?>
                                <h4 class="bigger pull-right"><?=$tot?></h4>
                            </div>
                        </div>
                    </div><!-- /.widget-main -->
    ...
    <input type="hidden" id="valide_fs" value="{{ Session::get('valid_fs')}}"/>
    <input type="hidden" id="non_valide_fs" value="{{ Session::get('non_valid_fs')}}"/>
    ...
    <script type="text/javascript">
        jQuery(function($) {
            ...
            var va = document.getElementById("valide_fs").value;
            var no_va = document.getElementById("non_valide_fs").value;
            var data = [
            ...
            var vaa = document.getElementById("valide_prov_fs").value;
            var no_vaa = document.getElementById("non_valide_prov_fs").value;
            var dataa = [
            ...
            var va_aca = document.getElementById("valide_aca_fs").value;
            var no_va_aca = document.getElementById("non_valide_aca_fs").value;
            var data_aca = [
            ...
            var va_fil = document.getElementById("valide_fil_fs").value;
            var no_va_fil = document.getElementById("non_valide_fil_fs").value;
            var data_fil = [
            ...
            var va_bac = document.getElementById("valide_bac_fs").value;
            var no_va_bac = document.getElementById("non_valide_bac_fs").value;
            var data_bac = [
