                ...
                <div class="widget-box">
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            <form class="form-horizontal" action="{{url('resultfiltre')}}" method="get" style="width: 200px;margin-left: 20px;">
                                {{csrf_field()}}
                                <div>
                                    <label>@lang('list.choix_fil')</label>
                                    <select class="form-control" name="filiere" id="form-field-select-1" style="margin-bottom: 10px;">
                                        ...
                                        @foreach($filieres as $filiere)
                                            <?php $fil=$filiere->libelle_filiere;?>
