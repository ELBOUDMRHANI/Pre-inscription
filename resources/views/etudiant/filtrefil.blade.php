                    ...
                    <table id="simple-table" class="table  table-bordered table-hover">
                        ...
                        @foreach($etudiants as $etudiant)
                            <tr>
                                ...
                                <td class="hidden-480">{{$etudiant->nom}}</td>
                                                    ...
                                                    <div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
                                                        <div class="inline position-relative">
                                                            <a class="user-title-label" href="#">
                                                                ...
                                                                &nbsp;
                                                                <span class="white">{{$etudiant->nom_prenom}}</span>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="profile-user-info profile-user-info-striped">
                                                    ...
                                                    <div class="profile-info-row">
                                                        ...
                                                        <div class="profile-info-value">
                                                            ...
                                                            <span>{{$etudiant->adressperso}}</span>
                                                        </div>
                                                    </div>
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            <form class="form-horizontal" action="{{url('resultfiltre')}}" method="post" style="width: 200px;margin-left: 20px;">
                                {{csrf_field()}}
                                <div>
