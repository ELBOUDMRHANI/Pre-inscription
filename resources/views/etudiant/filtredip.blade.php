                ...
                <div class="widget-box">
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            <form class="form-horizontal" action="{{url('filtrefil')}}" method="post" style="width: 200px;margin-left: 20px;">
                                {{csrf_field()}}
                                <div>
                            ...
                            <hr />
                            <form class="form-horizontal" action="{{url('filtre')}}" method="post" style="width: 200px;margin-left: 20px;">
                                {{csrf_field()}}
