                ...
                <form action="" method ="post" id="deleteForm" >
                    ...
                    <div class="modal-body">
                        ...
                        <div>
                            ...
                            <p> Êtes-vous sûr ...? vous voulez supprimer ce étudiant <span id="usr"></span></p>
                        </div>
                ...
                <table id="simple-table" class="table  table-bordered table-hover">
                    ...
                    <tr>
                       <!-- <th class="center">
                        ...
                        <th>@lang('list.cne')</th>
                        <th>@lang('list.massar')</th>
                        <th class="hidden-480">@lang('list.nom')</th>
                    ...
                    <tr>
                       ...
                       <!-- <td class="hidden-480">
                        ...
                        <td>
                                ...
                                <button id="{{$etudiant->id_etudiant}}" data-toggle="modal" data-target="#deleteModal" class="btn btn-xs btn-danger delete" title="supprimer">
                            ...
                            <div class="hidden-md hidden-lg">
                                <div class="inline pos-rel">
                                    ...
                                    <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                        ...
                                        <li>
                                            <a href="{{ url('/'.$etudiant->id_etudiant.'/dowcarte') }}" id="carte" data-rel="tooltip"  title="dowl" class="tooltip-error" >
                                            	                            <span class="red">
																				<i class="ace-icon fa fa-trash-o bigger-120"></i>
																			</span>
                                            </a>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-4">
                                        <div class="text-center">
                                            <?php $path=$etudiant->photo_etudiant;?>
                                                <?php if($path==null){?>
                                            <img height="150" class="thumbnail inline no-margin-bottom" alt="Domain Owner's Avatar" src="{{asset('assets/images/avatars/profile-pic.jpg')}}" />
                                                <?php } if($path!=null){?>
                                                <img height="150" class="thumbnail inline no-margin-bottom" alt="Domain Owner's Avatar" src="{{asset($path)}}" />
                                                <?php }?>
                                            <br />
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-body">
                            <div class="widget-main">
                                <form class="form-horizontal" action="{{url('filtredip')}}" method="get" style="width: 200px;margin-left: 20px;">
                                    {{csrf_field()}}
                                <div>
                                    ...
                                    <select class="form-control" name="etablissement" id="form-field-select-1" style="margin-bottom: 10px;">
                                        <option  disabled selected value>@lang('list.lab_choix_etab')</option>
                                        @foreach($etablissements as $etablissement)
                                            <option value="{{$etablissement->libelle_etablissement_fr}}" >{{$etablissement->libelle_etablissement_fr}}</option>
                                ...
                                <hr />
                                <form class="form-horizontal" action="{{url('filtre')}}" method="get" style="width: 200px;margin-left: 20px;">
                                    {{csrf_field()}}
                                   <div>
                                   ...
                                   <!-- </select>-->
                                        <div>
                                            ...
                                            <br />
                                            <select class="chosen-select form-control" name="filiere_sl" id="form-field-select-3" style="margin-bottom: 10px;" data-placeholder="Choose a State...">
